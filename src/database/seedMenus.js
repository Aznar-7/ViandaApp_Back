export const seedMenus = [
    ...
    ["Tarta de verduras", "Tarta integral de espinaca y ricota", "2026-06-09", "vegetariano", 900, 10, 1, "/assets/tarta_de_verduras.jpg"],
    ["Bowl vegano", "Bowl de quinoa con vegetales asados", "2026-06-10", "vegano", 1000, 8, 1, "/assets/bowl_vegano.jpeg"],
    ...
    ["Estofado de Yoda", "Estofado de raices y vegetales inspirado en Dagobah", "2026-06-13", "vegano", 1800, 8, 1, "/assets/estofado_yoda.jpg"],
    ["Desayuno de leche azul", "Avena, frutas y leche azul al estilo Tatooine", "2026-06-13", "vegetariano", 1350, 10, 1, "/assets/desayuno_leche_azul.jpg"],
];
